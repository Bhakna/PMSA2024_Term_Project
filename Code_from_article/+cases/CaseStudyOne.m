function [mu, sigma, Cs, T, init_transport_velocity, lung_dose_ug, plotFunction] = CaseStudyOne(i)

% Case study one : MCC and PSD
...
switch i
    ...
    case 2
        init_transport_velocity = 3.6 / 100 * 60; % 3.6 mm/min - > dm/h
        sigma = 0.1 * 0.6/2*1e-5; % [dm] (radius) Narrow distribution
    case 3
        init_transport_velocity = 0; % 3.6 mm/min - > dm/h
        sigma = 0.6/2*1e-5; % [dm] (radius)
...
subtitles = {'MCC + wide PSD', 'MCC + narrow PSD', 'No MCC + wide PSD'};
